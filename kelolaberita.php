            ...
            <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" name="isiberita" id="exampleTextarea" rows="3" placeholder="Enter text" required></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="submit" name="submit" class="btn btn-primary" value="TAMBAH BERITA">
                  </div>
                </div>
            </form>
          </div>
