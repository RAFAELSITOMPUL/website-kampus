...
<body>
  ...
  <section id="store">
    <div class="container">
      <h1 class="text-center mt-12">PENGABDIAN</h1>
      <div class="row">
    
        <div class="col-md-12"> 
          <div class="card mt-4">
          <img class="card-img-top" src="./gambar/th.jpg" alt="Card image cap">
            <div class="card-body">
            <h5 class="card-title"></h5>
            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet, distinctio velit! Iste quas, reiciendis, ad explicabo, quod molestias rem quia qui eius sit ducimus perferendis veritatis obcaecati repudiandae. Incidunt in laborum iusto repellat nesciunt magnam. Veritatis repellendus exercitationem eligendi placeat dignissimos commodi maiores modi tempora a quos earum beatae laudantium debitis consequuntur inventore natus, laboriosam voluptate nisi asperiores quae nulla molestiae et? Praesentium rem velit, architecto laboriosam beatae tempore mollitia voluptates eum voluptatem natus facere eius dolor error porro voluptas labore nesciunt quaerat aliquid quae deleniti sed iure repudiandae. Cumque pariatur doloribus eaque, in debitis minus iste fuga quos quae. </p>
            <p class="card-text"></p>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="container">
          <div class="row">
            <div class="col-md-4">
              <h5 class="card-title">Webstaida</h5>
